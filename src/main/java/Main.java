...
public class Main {
    public static void main(String[] args){
        List<Student> studentList = new ArrayList<>();//constructing three new students
...
//the following is all one statement
        ...
        //you initialize it byn calling the stream method
        studentList.stream()
                //use .map() to manipulate the dat data in some way
